...
/** resets the arm and follows the closeOffline path */
public class CloseOffline extends SequentialCommandGroup {
    public CloseOffline(DriveSubsystem drive, ArmSubsystem arm, ExtenderSubsystem extender) {
        addCommands(new Reset(arm, extender),

                    Offline.closeOffline(drive));
    }
}
